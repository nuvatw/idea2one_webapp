...
export default function AIAssistantModal() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-50 flex flex-col bg-surface animate-slide-up-modal"
          role="dialog"
          aria-modal="true"
          aria-label="AI 助手"
        >
          {/* Header */}
          <header className="flex items-center justify-between border-b border-warm-100 bg-surface-raised px-4 py-3">
            <div className="w-10" />
            ...
            <button
              onClick={close}
              className="flex h-10 w-10 items-center justify-center rounded-xl text-warm-400 transition-colors hover:bg-warm-100 hover:text-warm-700"
              aria-label="關閉聊天室"
            >
              <svg
                className="h-5 w-5"
          ...
          <div className="flex-1 overflow-y-auto px-4 py-5">
            {isLoadingHistory ? (
              ...
              <div className="flex h-full flex-col items-center justify-center">
                ...
                <h3 className="mb-1 text-lg font-bold text-warm-800">
                  你好！
                </h3>
          ...
          {/* Input area */}
          <div className="border-t border-warm-100 bg-surface-raised px-4 py-3 safe-bottom">
